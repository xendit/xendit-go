...
// ChannelsCategories the model 'ChannelsCategories'
type ChannelsCategories string

// List of ChannelsCategories
const (
	CHANNELSCATEGORIES_BANK ChannelsCategories = "BANK"
	CHANNELSCATEGORIES_CARDLESS_CREDIT ChannelsCategories = "CARDLESS_CREDIT"
	CHANNELSCATEGORIES_PAYLATER ChannelsCategories = "PAYLATER"
	CHANNELSCATEGORIES_CARDS ChannelsCategories = "CARDS"
	CHANNELSCATEGORIES_CASH ChannelsCategories = "CASH"
	CHANNELSCATEGORIES_DIRECT_DEBIT ChannelsCategories = "DIRECT_DEBIT"
	CHANNELSCATEGORIES_EWALLET ChannelsCategories = "EWALLET"
	CHANNELSCATEGORIES_INVOICE ChannelsCategories = "INVOICE"
	CHANNELSCATEGORIES_QR_CODE ChannelsCategories = "QR_CODE"
	CHANNELSCATEGORIES_RETAIL_OUTLET ChannelsCategories = "RETAIL_OUTLET"
	CHANNELSCATEGORIES_VIRTUAL_ACCOUNT ChannelsCategories = "VIRTUAL_ACCOUNT"
...
var AllowedChannelsCategoriesEnumValues = []ChannelsCategories{
	"BANK",
	"CARDLESS_CREDIT",
	"PAYLATER",
	"CARDS",
...
func (v *ChannelsCategories) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := ChannelsCategories(value)
...
func NewChannelsCategoriesFromValue(v string) (*ChannelsCategories, error) {
	ev := ChannelsCategories(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ChannelsCategories: valid values are %v", v, AllowedChannelsCategoriesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ChannelsCategories) IsValid() bool {
	for _, existing := range AllowedChannelsCategoriesEnumValues {
		if existing == v {
			return true
		}
...
func (v ChannelsCategories) String() string {
	return string(v)
}

// Ptr returns reference to ChannelsCategories value
func (v ChannelsCategories) Ptr() *ChannelsCategories {
	return &v
}

type NullableChannelsCategories struct {
	value *ChannelsCategories
	isSet bool
}

func (v NullableChannelsCategories) Get() *ChannelsCategories {
	return v.value
}

func (v *NullableChannelsCategories) Set(val *ChannelsCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableChannelsCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableChannelsCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChannelsCategories(val *ChannelsCategories) *NullableChannelsCategories {
	return &NullableChannelsCategories{value: val, isSet: true}
}

func (v NullableChannelsCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChannelsCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
