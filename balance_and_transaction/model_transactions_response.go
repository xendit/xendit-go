...
var _ utils.MappedNullable = &TransactionsResponse{}

// TransactionsResponse Returns an array of Transaction Objects. Returns empty array when there is no result.
