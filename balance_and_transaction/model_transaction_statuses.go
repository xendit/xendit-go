...
// TransactionStatuses the model 'TransactionStatuses'
type TransactionStatuses string

// List of TransactionStatuses
const (
	TRANSACTIONSTATUSES_SUCCESS TransactionStatuses = "SUCCESS"
...
func (v TransactionStatuses) String() string {
	return string(v)
}

// Ptr returns reference to TransactionStatuses value
