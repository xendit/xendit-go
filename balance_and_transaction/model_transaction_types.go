...
const (
	TRANSACTIONTYPES_BATCH_DISBURSEMENT TransactionTypes = "BATCH_DISBURSEMENT"
	TRANSACTIONTYPES_DISBURSEMENT TransactionTypes = "DISBURSEMENT"
	TRANSACTIONTYPES_PAYMENT TransactionTypes = "PAYMENT"
	TRANSACTIONTYPES_REMITTANCE TransactionTypes = "REMITTANCE"
	TRANSACTIONTYPES_REMITTANCE_PAYOUT TransactionTypes = "REMITTANCE_PAYOUT"
	TRANSACTIONTYPES_REMITTANCE_COLLECTION TransactionTypes = "REMITTANCE_COLLECTION"
	TRANSACTIONTYPES_TRANSFER TransactionTypes = "TRANSFER"
	TRANSACTIONTYPES_PLATFORM_FEE TransactionTypes = "PLATFORM_FEE"
	TRANSACTIONTYPES_REFUND TransactionTypes = "REFUND"
	TRANSACTIONTYPES_CASHBACK TransactionTypes = "CASHBACK"
...
func (v TransactionTypes) String() string {
	return string(v)
}
