...
type PaymentMethodApi interface {
	...
	*/
	...
	AuthPaymentMethodExecute(r ApiAuthPaymentMethodRequest) (*PaymentMethod, *http.Response, error)
	...
	*/
	...
	//  @return PaymentMethod
	CreatePaymentMethodExecute(r ApiCreatePaymentMethodRequest) (*PaymentMethod, *http.Response, error)
	...
	*/
	...
	//  @return PaymentMethod
	ExpirePaymentMethodExecute(r ApiExpirePaymentMethodRequest) (*PaymentMethod, *http.Response, error)
	...
	*/
	...
	GetAllPaymentChannelsExecute(r ApiGetAllPaymentChannelsRequest) (*PaymentChannelList, *http.Response, error)
	...
	*/
	...
	GetAllPaymentMethodsExecute(r ApiGetAllPaymentMethodsRequest) (*PaymentMethodList, *http.Response, error)
	...
	*/
	...
	//  @return PaymentMethod
	GetPaymentMethodByIDExecute(r ApiGetPaymentMethodByIDRequest) (*PaymentMethod, *http.Response, error)
	...
	*/
	...
	//  @return PaymentMethod
	PatchPaymentMethodExecute(r ApiPatchPaymentMethodRequest) (*PaymentMethod, *http.Response, error)
...
func (r ApiAuthPaymentMethodRequest) Execute() (*PaymentMethod, *http.Response, error) {
...
//  @return PaymentMethod
func (a *PaymentMethodApiService) AuthPaymentMethodExecute(r ApiAuthPaymentMethodRequest) (*PaymentMethod, *http.Response, error) {
	var (
...
func (r ApiExpirePaymentMethodRequest) Execute() (*PaymentMethod, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentMethod
func (a *PaymentMethodApiService) ExpirePaymentMethodExecute(r ApiExpirePaymentMethodRequest) (*PaymentMethod, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []common.FormFile
...
func (r ApiGetAllPaymentChannelsRequest) Execute() (*PaymentChannelList, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentChannelList
func (a *PaymentMethodApiService) GetAllPaymentChannelsExecute(r ApiGetAllPaymentChannelsRequest) (*PaymentChannelList, *http.Response, error) {
	var (
...
func (r ApiGetAllPaymentMethodsRequest) Execute() (*PaymentMethodList, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentMethodList
func (a *PaymentMethodApiService) GetAllPaymentMethodsExecute(r ApiGetAllPaymentMethodsRequest) (*PaymentMethodList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []common.FormFile
...
func (r ApiGetPaymentMethodByIDRequest) Execute() (*PaymentMethod, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentMethod
func (a *PaymentMethodApiService) GetPaymentMethodByIDExecute(r ApiGetPaymentMethodByIDRequest) (*PaymentMethod, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []common.FormFile
...
func (r ApiGetPaymentsByPaymentMethodIdRequest) AfterId(afterId string) ApiGetPaymentsByPaymentMethodIdRequest {
	r.afterId = &afterId
	return r
}

func (r ApiGetPaymentsByPaymentMethodIdRequest) BeforeId(beforeId string) ApiGetPaymentsByPaymentMethodIdRequest {
	r.beforeId = &beforeId
	return r
}
...
func (r ApiPatchPaymentMethodRequest) Execute() (*PaymentMethod, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentMethod
func (a *PaymentMethodApiService) PatchPaymentMethodExecute(r ApiPatchPaymentMethodRequest) (*PaymentMethod, *http.Response, error) {
	var (
...
// Execute executes the request
func (a *PaymentMethodApiService) SimulatePaymentExecute(r ApiSimulatePaymentRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []common.FormFile
	...
	if err != nil {
		return nil, common.NewGenericOpenAPIError(nil, err.Error(), nil)
	}
