...
type PaymentRequestApi interface {
	...
	*/
	...
	AuthorizePaymentRequestExecute(r ApiAuthorizePaymentRequestRequest) (*PaymentRequest, *http.Response, error)
	...
	*/
	...
	//  @return PaymentRequest
	CreatePaymentRequestExecute(r ApiCreatePaymentRequestRequest) (*PaymentRequest, *http.Response, error)
	...
	*/
	...
	GetAllPaymentRequestsExecute(r ApiGetAllPaymentRequestsRequest) (*PaymentRequestListResponse, *http.Response, error)
	...
	*/
	...
	//  @return PaymentRequest
	GetPaymentRequestByIDExecute(r ApiGetPaymentRequestByIDRequest) (*PaymentRequest, *http.Response, error)
	...
	*/
	...
	//  @return PaymentRequest
	ResendPaymentRequestAuthExecute(r ApiResendPaymentRequestAuthRequest) (*PaymentRequest, *http.Response, error)
}
...
func (r ApiAuthorizePaymentRequestRequest) Execute() (*PaymentRequest, *http.Response, error) {
...
//  @return PaymentRequest
func (a *PaymentRequestApiService) AuthorizePaymentRequestExecute(r ApiAuthorizePaymentRequestRequest) (*PaymentRequest, *http.Response, error) {
	var (
...
func (r ApiCapturePaymentRequestRequest) Execute() (*Capture, *http.Response, error) {
...
func (r ApiGetAllPaymentRequestsRequest) Execute() (*PaymentRequestListResponse, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentRequestListResponse
func (a *PaymentRequestApiService) GetAllPaymentRequestsExecute(r ApiGetAllPaymentRequestsRequest) (*PaymentRequestListResponse, *http.Response, error) {
	var (
...
func (r ApiGetPaymentRequestByIDRequest) Execute() (*PaymentRequest, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentRequest
func (a *PaymentRequestApiService) GetPaymentRequestByIDExecute(r ApiGetPaymentRequestByIDRequest) (*PaymentRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []common.FormFile
...
func (r ApiGetPaymentRequestCapturesRequest) Execute() (*CaptureListResponse, *http.Response, error) {
...
// Execute executes the request
//  @return CaptureListResponse
func (a *PaymentRequestApiService) GetPaymentRequestCapturesExecute(r ApiGetPaymentRequestCapturesRequest) (*CaptureListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []common.FormFile
...
func (r ApiResendPaymentRequestAuthRequest) Execute() (*PaymentRequest, *http.Response, error) {
...
// Execute executes the request
//  @return PaymentRequest
func (a *PaymentRequestApiService) ResendPaymentRequestAuthExecute(r ApiResendPaymentRequestAuthRequest) (*PaymentRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []common.FormFile
