...
func (dst *IdentityAccountResponseProperties) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("data failed to match schemas in anyOf(IdentityAccountResponseProperties)")
}
...
type NullableIdentityAccountResponseProperties struct {
	value *IdentityAccountResponseProperties
	isSet bool
}

func (v NullableIdentityAccountResponseProperties) Get() *IdentityAccountResponseProperties {
	return v.value
}

func (v *NullableIdentityAccountResponseProperties) Set(val *IdentityAccountResponseProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityAccountResponseProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityAccountResponseProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityAccountResponseProperties(val *IdentityAccountResponseProperties) *NullableIdentityAccountResponseProperties {
	return &NullableIdentityAccountResponseProperties{value: val, isSet: true}
}

func (v NullableIdentityAccountResponseProperties) MarshalJSON() ([]byte, error) {
