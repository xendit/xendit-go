	...
	for _, tC := range testCases {
		t.Run(tC.desc, func(t *testing.T) {
			apiRequesterMockObj.On(
				...
				context.Background(),
				"POST",
				xendit.Opt.XenditURL+"/v2/payment_method/id/auth",
				xendit.Opt.SecretKey,
				mock.AnythingOfType("http.Header"),
				tC.data,
				&xendit.PaymentMethodResponse{},
	...
	for _, tC := range testCases {
		t.Run(tC.desc, func(t *testing.T) {
			apiRequesterMockObj.On(
				...
				context.Background(),
				"POST",
				xendit.Opt.XenditURL+"/v2/payment_method/id/expire",
				xendit.Opt.SecretKey,
				mock.AnythingOfType("http.Header"),
				tC.data,
				&xendit.PaymentMethodResponse{},
	...
	for _, tC := range testCases {
		t.Run(tC.desc, func(t *testing.T) {
			apiRequesterMockObj.On(
				...
				context.Background(),
				"GET",
				xendit.Opt.XenditURL+"/v2/payment_method/id",
				xendit.Opt.SecretKey,
				mock.AnythingOfType("http.Header"),
				nil,
				&xendit.PaymentMethodResponse{},
	...
	for _, tC := range testCases {
		t.Run(tC.desc, func(t *testing.T) {
			apiRequesterMockObj.On(
				...
				context.Background(),
				"GET",
				xendit.Opt.XenditURL+"/v2/payment_method/id/payments?limit=5",
				xendit.Opt.SecretKey,
				mock.AnythingOfType("http.Header"),
				nil,
				&xendit.PaymentMethodResponse{},
