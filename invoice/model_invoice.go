...
type Invoice struct {
	...
	ClientType InvoiceClientType `json:"client_type"`
	// Representing a date and time in ISO 8601 format.
...
// GetIsHigh returns the IsHigh field value
...
// GetIsHighOk returns a tuple with the IsHigh field value
// and a boolean to check if the value has been set.
func (o *Invoice) GetIsHighOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsHigh, true
}

// SetIsHigh sets field value
