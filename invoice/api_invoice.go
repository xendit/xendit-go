...
type InvoiceApi interface {
	...
	*/
	...
	//  @return Invoice
	CreateInvoiceExecute(r ApiCreateInvoiceRequest) (*Invoice, *http.Response, error)
	...
	*/
	...
	//  @return Invoice
	ExpireInvoiceExecute(r ApiExpireInvoiceRequest) (*Invoice, *http.Response, error)
	...
	*/
	...
	//  @return Invoice
	GetInvoiceByIdExecute(r ApiGetInvoiceByIdRequest) (*Invoice, *http.Response, error)
	...
	*/
	...
	//  @return []Invoice
	GetInvoicesExecute(r ApiGetInvoicesRequest) ([]Invoice, *http.Response, error)
}
...
func (a *InvoiceApiService) CreateInvoiceExecute(r ApiCreateInvoiceRequest) (*Invoice, *http.Response, error) {
	...
	if r.createInvoiceRequest == nil {
		return localVarReturnValue, nil, utils.ReportError("createInvoiceRequest is required and must be specified")
	}
...
func (r ApiExpireInvoiceRequest) Execute() (*Invoice, *http.Response, error) {
...
// Execute executes the request
//  @return Invoice
func (a *InvoiceApiService) ExpireInvoiceExecute(r ApiExpireInvoiceRequest) (*Invoice, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []common.FormFile
...
// Execute executes the request
//  @return Invoice
func (a *InvoiceApiService) GetInvoiceByIdExecute(r ApiGetInvoiceByIdRequest) (*Invoice, *http.Response, error) {
	var (
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v InvoiceError404ResponseDefinition
			err = a.client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.SetError(err.Error())
				return localVarReturnValue, localVarHTTPResponse, newErr
